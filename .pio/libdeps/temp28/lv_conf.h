...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(arimo_18) LV_FONT_DECLARE(arimo_22) LV_FONT_DECLARE(arimo_30) LV_FONT_DECLARE(arimo_44)

/*Always set a default font*/
//#define LV_FONT_DEFAULT &lv_font_montserrat_14
#define LV_FONT_DEFAULT &arimo_18
